...
import React from "react";
import { FaLinkedinIn, FaXTwitter, FaWhatsapp, FaGithub } from "react-icons/fa";
import { MdOutlineEmail } from "react-icons/md";
import { SiLeetcode } from "react-icons/si";
import profileImage from "../assets/images/prolife-pic.jpg";
...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="min-h-[calc(100vh-4rem)] flex flex-col justify-center pt-4 pb-16"
    >
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-8">
        {/* Text content */}
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h1 className="text-4xl sm:text-5xl font-bold text-[#1788ae] mb-3">
            Chandan
          </h1>
          <h2 className="text-2xl sm:text-3xl text-gray-700 mb-4">
            MERN Stack Developer
          </h2>
          ...
          <a
            href="/Chandan_Resume.pdf"
            download="Chandan_Resume.pdf"
            className="inline-block bg-[#1788ae] hover:bg-[#147899] text-white py-2 px-6 sm:py-3 sm:px-8 rounded-full font-medium transition-colors duration-300 shadow-md"
          >
            Download Resume
          </a>
        </div>
        ...
        {/* Social media links */}
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 md:left-auto md:right-8 md:transform-none">
          <ul className="flex md:flex-col gap-4 bg-white bg-opacity-80 backdrop-blur-sm p-3 rounded-full shadow-lg">
            <li>
              <a
                href="https://www.linkedin.com/in/chandan-42133a221/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#1788ae] hover:text-gray-500 transition-colors"
              >
                <FaLinkedinIn className="text-2xl" />
              </a>
            </li>
